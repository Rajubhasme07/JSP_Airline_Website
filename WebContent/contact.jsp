        ...
        <div class="row d-flex contact-info">
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel://1234567920">+919561228272</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="mailto:info@yoursite.com">rajubhasme33@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="https://www.linkedin.com/in/raju-bhasme-8a813a227/">linkdin</a></p>
	          </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row block-9">
          <div class="col-md-6 order-md-last d-flex">
            <form action="custquires.jsp" class="bg-light p-5 contact-form">
              <div class="form-group">
                <input type="text" class="form-control" name="cname" placeholder="Your Name">
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name="cemail" placeholder="Your Email">
              </div>
              <div class="form-group">
                <input type="text" class="form-control" name= "csub" placeholder="Subject">
              </div>
              <div class="form-group">
                <textarea type="text"  id="" cols="30" rows="7"  name="cmess" class="form-control" placeholder="Message"></textarea>
              </div>
              <div class="form-group">
