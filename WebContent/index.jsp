	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item cta"><a href="login_user.jsp" class="nav-link">Login</a></li>
	    	...
	    	<div class="row">
					<div class="col-md-12">
						<div class="search-wrap-1 ftco-animate p-4">
							<form action="lgserv.jsp" class="search-property-1">
		        		<div class="row">
		        			...
		        			<div class="col-lg align-items-end">
				                ...
				                <input type="text" name="swhefrm" class="form-control" placeholder="Where from">
		        			...
		        			<div class="col-lg align-items-end">
		        				<div class="form-group">
		          				...
		          				<div class="form-field">
		          					<div class="icon"><span class="ion-ios-search"></span></div>
				                <input type="text" name="swhereto" class="form-control" placeholder="Where to">
				              </div>
			              </div>
		        			</div>
		        			<div class="col-lg align-items-end">
				                ...
				                <input type="text" name="sdeapdate" class="form-control checkin_date" placeholder="Check Depature Date">
				              </div>
			              </div>
		        			</div>
      ...
      <div class="container">
        <div class="row d-flex">
          <div class="col-md-6 order-md-last heading-section pl-md-5 ftco-animate">
          	<h2 class="mb-4">It's time to travel</h2>
                ...
                <div class="testimony-wrap py-4">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	...
                    	<div class="pl-3">
		                    <p class="name">Harshal Mandale</p>
		                    <span class="position">Software Devloper</span>
		                  </div>
	                  </div>
                  </div>
                </div>
